...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create remix-demo-43d9
  fly apps create remix-demo-43d9-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-demo-43d9
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-demo-43d9-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'remix-demo-43d9-staging' does not match app name in config file 'remix-demo-43d9'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name remix-demo-43d9-db
  fly postgres attach --app remix-demo-43d9 remix-demo-43d9-db

  fly postgres create --name remix-demo-43d9-staging-db
  fly postgres attach --app remix-demo-43d9-staging remix-demo-43d9-staging-db
  ```
